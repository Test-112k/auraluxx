      ...
      >
        <div className="auraluxx-container">
          <div className="flex items-center justify-between py-4">
            ...
            <div className="relative flex-1 max-w-xs md:max-w-sm mx-2 md:mx-4">
              <SimpleSearchBar />
            </div>
            ...
            <div className="flex items-center gap-2 md:hidden">
              ...
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-white hover:text-aura-purple transition-colors p-2 min-h-[44px] min-w-[44px] flex items-center justify-center"
                aria-label="Telegram"
              >
                <svg 
                  className="h-6 w-6" 
